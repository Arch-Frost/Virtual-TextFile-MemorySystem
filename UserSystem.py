...
class UserSystem:
    ...
    def create_user(self, username, password):
        ...
        # Also create the user's individual file (username.pickle)
        user_data = {
            "title": "credentials",
            "username": username,
            "encryption_key": encryption_key
        ...
        user_file = os.path.join(self.users_folder, f"{username}.pickle")
    ...
    def login_user(self, username, password):
        ...
        if username not in self.credentials_data:
